...
| ** Omni ** | Soutien / Commandement | Équilibre, capacités C³ (commandement, contrôle, communication). | N'excelle dans aucun domaine, dépend de l'escouade. | Fusil d'assaut modulable, Drones de support, Kit de réparation rapide. |`
    ...
    ACT_3_LEVIATHAN_OUTRO_CHOICE: {
        ...
        choices: [
            { text: "Accepter l'offre d'Aetheria. La survie avant l'idéologie. (Augmente Réputation Aetheria)", next: "ENDING_SUCCESS_CORPO", },
            { text: "Obéir à la CEL : Détruire toutes les preuves et fuir. (Augmente Réputation CEL)", next: "ACT_3_LEVIATHAN_ESCAPE_VITESSE", },
            { text: "Obéir partiellement à la CEL : Détruire l'épave mais envoyer les données recueillies au haut commandement CEL. (Augmente Réputation CEL)", next: "ENDING_SUCCESS_CEL", },
            { text: "Détruire l'épave et envoyer les données à une faction de la FEU, contre extraction et protection. (Diminue Réputation CEL/Aetheria)", next: "ENDING_SUCCESS_FEU",  },
            { text: "Détruire l'épave et envoyer les données aux 2 camps. (Diminue Réputation CEL/Aetheria)", next: "ENDING_SUCCESS_REBEL", }
        ],
    },
