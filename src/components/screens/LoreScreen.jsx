        ...
        <div className="p-6 md:p-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              ...
              après la technologie, et des techniques simples ont permis de
              rendre fou certaines personnes.. imaginez un "Popup bomber" en
              réalité augmentée ! Au fur et a mesure des builds, la securité a
              été renforcé mais vous trouverez toujours de petits malins pour
              trouver LA faille..
            </p>
